...
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # مثلا https://mehrozkiyad-bot.onrender.com
...
dispatcher.add_handler(date_conv)
dispatcher.add_handler(CallbackQueryHandler(healing_start, pattern='healing'))
