...
from utils.healing_service import get_healing_text  # فرض کنیم موجود است
...
telegram_app.add_handler(horoscope_handler)
telegram_app.add_handler(date_conv_handler)
telegram_app.add_handler(CallbackQueryHandler(healing_start, pattern='healing'))
telegram_app.add_handler(CallbackQueryHandler(about, pattern='about'))
